...
libtrie = ffi.dlopen(os.path.join(os.path.dirname(os.path.abspath(__file__)), "libtrie.dylib"))
libtrieprint = ffi.dlopen(os.path.join(os.path.dirname(os.path.abspath(__file__)), "libtrieprint.dylib"))
